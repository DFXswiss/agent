...
(`PR-GUARD:CI-MANUAL:v1`). Visible sentences use `@login` when GitHub reports a
User login, otherwise “an administrator” / “einem Administrator”. That comment
